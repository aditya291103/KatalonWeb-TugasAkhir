...
WebUI.comment("Input Field Valid Email")
WebUI.setText(findTestObject('Object Repository/login_page/Input_email'), "dev@imprint.co.id")

WebUI.comment("Input Field Invalid Password")
WebUI.setText( findTestObject('Object Repository/login_page/Input_password'), "abcdvsisd")
