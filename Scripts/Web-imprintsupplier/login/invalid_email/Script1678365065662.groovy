...
WebUI.comment("Input Field Invalid Email")
WebUI.setText(findTestObject('Object Repository/login_page/Input_email'), "sev@imprint.co.id")

WebUI.comment("Input Field Valid Password")
...
WebUI.comment("validasi pass email salah")
WebUI.waitForElementPresent(findTestObject('Object Repository/login_page/pass_email_salah'), 10)
